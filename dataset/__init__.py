...
class TranslationDataset(object):
    ...
    # def __call__(self, graph_pool, mode='train', batch_size=32, k=1, device='cpu', dev_rank=0, ndev=1):
    def __call__(self, graph_pool, mode='train', batch_size=32, k=1, device=torch.device, dev_rank=0, ndev=1):
        '''
...
def get_dataset(dataset):
    ...
    if dataset == 'babi':
        ...
        return TranslationDataset('data/{}'.format(dataset), ('in', 'out'), train='train', valid='valid', test='test',)
